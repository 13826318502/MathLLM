"""Single-question solving endpoint."""
...
from app.api.models import AnswerResponse, SolveRequest
...
async def solve(
    ...
    try:
        messages = build_solve_messages(request.question, settings.max_question_chars)
